...
**Tailwind styling ideas**
Used AI to confirm responsive classes, layout patterns, and quick styling patterns.

**Configuration setup**
Asked AI how to configure:

=> next.config.js image domains

=> Tailwind setup steps

=> Environment variable usage with Next.js App Router

**Search component logic**
Used AI to help reason about issues with refs, click handlers, and dropdown behavior.

**Utility functions and fetch patterns**
Used AI for examples of server-side fetch helpers and safe error handling patterns.
